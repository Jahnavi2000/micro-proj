...
app.post('/searchventbyname',middleware.checkToken,(req,res)=>{
    var name=req.query.hosname;//by hospital name searching ventilators
    console.log(name);
    var ventilatordetails=db.collection('Ventilators').find({'hosname':new RegExp(name,'i')}).toArray().then(result=>res.json(result));
});
